      ...
      <div class="w-full max-w-full flex-none px-3">
        <div
          ...
          <div class="border-b-solid mb-4 rounded-t-2xl border-b-0 border-b-transparent p-6 pb-0">
            <h6 class="dark:text-white">Update Portfolio</h6>
          </div>
            ...
            <form action="{{ route('admin.portfolios.update', $portfolio->id) }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="-mx-3 mb-6 flex flex-wrap">
                <div class="w-full px-3">
                  <label class="mb-2 block text-xs font-bold uppercase tracking-wide text-gray-700" for="name"> Nama Portfolio Company : </label>
                  ...
                  <div class="mt-0 text-sm text-gray-500">
                    Nama Portfolio Company. Contoh: PT Citra Tubindo Tbk. Wajib diisi. Maksimal 255 karakter.
                  </div>
                </div>
              </div>
              ...
              <div class="-mx-3 mb-6 flex flex-wrap">
                <div class="w-full px-3">
                  ...
                  <input type="number" name="year_created" value="{{ old('year_created') ?? $portfolio->year_created }}" min="2020"
                    placeholder="Masukkan Tahun Pembuatan"
                    class="mb-1 block w-full appearance-none rounded border border-gray-200 bg-gray-200 py-3 px-4 leading-tight text-gray-700 focus:border-gray-500 focus:bg-white focus:outline-none"
                    required />
                  <div class="mt-0 text-sm text-gray-500">
                    Tahun Pembuatan. Contoh: 2022, 2023. Wajib diisi. Maksimal 4 karakter.
                  </div>
                </div>
              </div>
